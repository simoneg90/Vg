...
do
    ...
    combine -M Asymptotic -m ${mass} ${dcardName}.txt  --rMax 2.0 -L libdiphotonsUtils | tee ${logName}
...
combine -M Asymptotic -m ${mass} --rMax 2.0 -L libdiphotonsUtils datacard_qqg_${mass}_combined.txt | tee asymp_${mass}_combo.log
